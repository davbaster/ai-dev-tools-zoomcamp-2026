...
Claim, heartbeat, terminal submission, and recovery share the database
transaction seam; PostgreSQL claims additionally use row locking so concurrent
workers cannot select the same queued task.
"""
